...
class AgriPvSystemDesignScreen extends ConsumerStatefulWidget {
  const AgriPvSystemDesignScreen({super.key});

  @override
  ConsumerState<AgriPvSystemDesignScreen> createState() => _AgriPvSystemDesignScreenState();
}

class _AgriPvSystemDesignScreenState extends ConsumerState<AgriPvSystemDesignScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final farmArea = draftFarm.areaAcres > 0 ? draftFarm.areaAcres : 2.35;
    final farmCrop = draftFarm.crop.isNotEmpty ? draftFarm.crop : 'Wheat';
    ...
    final design = AgriPvCalculationService.generateDesign(
      id: 'custom_config',
      name: '${draftFarm.name.isNotEmpty ? draftFarm.name : "Custom"} System',
      areaAcres: farmArea,
      crop: farmCrop,
                ...
                children: [
                  ...
                  Expanded(
                    child: AppButton(
                      ...
                      onPressed: () {
                        ref.read(draftFarmProvider.notifier).setDesign(design);
